...
const Newsletter = () => {
    return (
        <div className="relative z-10 bg-blue-500 rounded-3xl py-20">
                ...
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
                    ...
                    <div className="p-10 flex flex-col justify-center">
                        ...
                        <div className="flex gap-0">
                            <input type="email" name="q" className="py-4 text-sm w-full text-black bg-white rounded-l-lg pl-4" placeholder="@enter email-address" autoComplete="off" />
